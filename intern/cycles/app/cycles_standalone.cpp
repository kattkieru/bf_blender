...
#include "app/cycles_denoising.h"
...
static void options_parse(int argc, const char **argv)
{
	...
	else if(!denoise && (options.scene_params.shadingsystem == SHADINGSYSTEM_OSL && options.session_params.device.type != DEVICE_CPU)) {		fprintf(stderr, "OSL shading system only works with CPU device\n");
		exit(EXIT_FAILURE);
	}
#endif
